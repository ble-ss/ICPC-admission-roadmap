...
- The Coupon Collector Problem  (from youtube)
...
- https://www.youtube.com/watch?v=JUzYl1TYMcU&t=18s 
## Extended euclid algorithm
### given the gcd of two numbers determine the number
- https://cp-algorithms.com/algebra/extended-euclid-algorithm.html  
- https://www.hackerrank.com/contests/test-contest-47/challenges/m158-multiple-euclid  (must try).
## Aplication of extended euclid algo    

### first we need to understand multiplicative modulo inverse
- https://cp-algorithms.com/algebra/module-inverse.html (mmi)
- or geegks for geeks  
#### application
![application](image.png)

## Seive of erithesthinis
- https://www.youtube.com/watch?v=yB57bcffJo4
- geeks for geeks
- https://www.geeksforgeeks.org/problems/sieve-of-eratosthenes5242/1
## segment seive 
#### seive of erethesthinis can not define the primes of a big number li 10^9 , so we use segment seive
- https://www.youtube.com/watch?v=fByR5N-TseY
- Geeks for Geeks
- https://www.geeksforgeeks.org/problems/product-of-primes5328/1
## Linear Diophanite algo
- https://cp-algorithms.com/algebra/linear-diophantine-equation.html
- https://www.hackerrank.com/challenges/sherlock-and-the-beast/problem
- https://www.geeksforgeeks.org/problems/find-x-and-y-in-linear-equation1334/1
- Four practice problem of cp algorithm
## Eular totion function
- https://cp-algorithms.com/algebra/phi-function.html
- https://www.youtube.com/watch?v=vPum8EqmFz0 (0.50-1.16)
## wilson theorem 
...
- CP-Algorithm Fenwick Tree Documentation: https://cp-algorithms.com/data_struct...
